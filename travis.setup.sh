...
curl -X POST -H 'Content-type: application/json' 'http://localhost:8000/v1/key/apiaxle-travis-ci-key' -d '{"sharedSecret":"apiaxle-travis-ci-secret","qps":1000,"qpd":10000}'
